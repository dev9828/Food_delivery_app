...
class CartHistory extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    Map<String,int> cartItemsPerOrder=Map(); // string--->date, int-> value
...
//     }).toList();
    ...
    List<int> orderTimes=cartItemsPerOrderToList();// 3,2,2
    print(orderTimes);
    ...
    Widget timeWidget(int index){
      ...
      if(index<getCartHistoryList.length){
        ...
        var outputFormat= DateFormat("MM/dd/yyyy hh:mn a");
        ...
        children: [
          ...
          GetBuilder<CartController>(builder: (_cartController){
            return _cartController.getCartHistoryList().length>0?Expanded(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Row(
                                  ...
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: [
                                    Wrap(// it lets u draw same thing again and again in any direcn
              ...
              child: const Center(
                child: const NoDataPage(text: "Your didnt buy anything so far",
                  imgPath:"assets/image/download1.png" ,
                ),
              ),
            );
          },)
