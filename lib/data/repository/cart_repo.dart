...
class CartRepo{
     ...
     // shared Preferences stored data as string
     // convert objects to string coz sharedpreferences only accepts strings
     List<String> cart=[];
     List<String> cartHistory=[];
     /// when we want to add data to server or local database
     ...
     ///// capture cart items and save it to local database and delete from cart eventually
